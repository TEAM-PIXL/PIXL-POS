...
public class AdminScreenHomeController {
    ...
    public void initialize() {
        ...
        addStockAlertListView(stockalertlistview, "1", "Cheese",Stock.StockStatus.INSTOCK, false);
        addStockAlertListView(stockalertlistview, "2", "Bread",Stock.StockStatus.LOWSTOCK, true);
        addStockAlertListView(stockalertlistview, "3", "Tomato",Stock.StockStatus.NOSTOCK, false);
